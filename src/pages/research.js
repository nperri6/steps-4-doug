...
import Uchicago from "../images/Uchicago.gif";
import Roos from "../images/roosi.jpg";
import ChicagoPaper from "../images/chicagoPaper.png";
import Bracelet from "../images/bracelet2.jpg";
	...
	render() {
		return (
			<div className={styles.main}>
                ...
                <div className={[styles.leftPicture, styles.bottomPicture].join(' ')}><img src={Roos}/></div>
                <div className={[styles.centerPicture, styles.bottomPicture].join(' ')}><img src={ChicagoPaper}/> </div>
                <div className={[styles.rightPicture, styles.bottomPicture].join(' ')}><img src={Bracelet}/></div>
			</div>
		)
	}
}
